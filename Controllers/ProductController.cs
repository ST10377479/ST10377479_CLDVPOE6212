    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product product, IFormFile imageFile)
        {
            ...
            try
            {
                ...
                var response = await httpClient.PostAsync("https://st10377479.azurewebsites.net/api/StoreProduct?code=jPa2JuvuJl6KJECaWqjagmCI-Ydi0GZZPLSTn_dDmPikAzFu1krZJQ%3D%3D", httpContent);

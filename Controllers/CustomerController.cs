...
namespace ABCRetailApp.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> StoreCustomer(CustomerProfile customer)
        {
            ...
            var response = await _httpClient.PostAsync("https://st10377479.azurewebsites.net/api/StoreCustomerProfile?code=jPa2JuvuJl6KJECaWqjagmCI-Ydi0GZZPLSTn_dDmPikAzFu1krZJQ%3D%3D", content);

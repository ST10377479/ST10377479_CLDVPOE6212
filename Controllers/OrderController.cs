        ...
        public async Task<IActionResult> Create()
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var response = await _httpClient.PostAsync("https://st10377479.azurewebsites.net/api/orders/send?code=jPa2JuvuJl6KJECaWqjagmCI-Ydi0GZZPLSTn_dDmPikAzFu1krZJQ%3D%3D", content);
